...
//made my variable called card and it's a long int
long card;

//prompt for card no if less than 0 (get_long means prompt user)
    do
    {
...
//find the digits that weren't x'd
...
//is amex
while(amex >= 1000000000000000)
{
    amex /= 1000000000000000;
}
